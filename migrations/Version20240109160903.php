 ...
 */
final class Version20240109160903 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produits (id INT AUTO_INCREMENT NOT NULL, id_categories_id INT NOT NULL, nom_produits VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, quantity INT NOT NULL, date_ajout DATE NOT NULL, INDEX IDX_BE2DDF8C1C3AC5D2 (id_categories_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
